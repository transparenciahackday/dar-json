Diário da Assembleia da República (JSON)
========================================

Este repositório contém versões JSON das sessões plenárias do Parlamento português. Foi originalmente criado e mantido para o projecto Demo.cratica.
